...
public class MapsActivityCurrentPlace extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(@NonNull Place place) {
                ...
                AddLocationActivity.clickStart(MapsActivityCurrentPlace.this,
                        place.getAddress(),
                        place.getName(),
    ...
    public void onMapReady(GoogleMap map) {
        ...
        map.setOnMarkerDragListener(new GoogleMap.OnMarkerDragListener() {
            ...
            public void onMarkerDragEnd(@NonNull @NotNull Marker marker) {
                ...
                Toast.makeText(MapsActivityCurrentPlace.this, markerLatitude + ", " + markerLongitude, Toast.LENGTH_SHORT).show();
            }
        });
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (lastKnownLocation != null) {
                                ...
                                curLongitude = lastKnownLocation.getLongitude();

                                markerLatitude = lastKnownLocation.getLatitude();
                                markerLongitude = lastKnownLocation.getLongitude();
    ...
    private void getLocationPermission() {
        ...
        if (ContextCompat.checkSelfPermission(this.getApplicationContext(),
            ...
            try {
                ...
                Log.e("MapsActivityCurrent", "exception: " + e);
            }
            ...
            placeResult.addOnCompleteListener (new OnCompleteListener<FindCurrentPlaceResponse>() {
                ...
                public void onComplete(@NonNull Task<FindCurrentPlaceResponse> task) {
                    if (task.isSuccessful() && task.getResult() != null) {
                        ...
                        List<PlaceAddressItem> placeList = new ArrayList<>();
                        ...
                        for (PlaceLikelihood placeLikelihood : likelyPlaces.getPlaceLikelihoods()) {
                            ...
                            double latitude = likelyPlaceLatLngs[i].latitude;
                            double longitude = likelyPlaceLatLngs[i].longitude;


                            PlaceAddressItem item = new PlaceAddressItem(likelyPlaceNames[i], likelyPlaceAddresses[i], latitude, longitude);
                            placeList.add(item);
                        ...
                        PlaceAddressAdapter adapter = new PlaceAddressAdapter(placeList);
    ...
    private void addMarker() {
        // Add a draggable marker in current location
        LatLng curLocation = new LatLng(curLatitude, curLongitude);
        map.addMarker(new MarkerOptions()
                .position(curLocation)
                .title("You can move the Cursor")
                .draggable(true)
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.map_marker)));
    }

    private void useCursorLocation() {
        startActivity(new Intent(MapsActivityCurrentPlace.this, AddLocationActivity.class)
                .putExtra("latitude", markerLatitude)
                .putExtra("longitude", markerLongitude));
    }
